		...
		function ShowResult($fid, $sid, $gid)
		{
			...
			if ($result)
			{
				...
				{ 
					...
					{
					echo" <td><div align=center class=style13><strong><a href='bethistory_details2_admin.php?fid=". $fid ."&gid=". $gid ."&sid=". $sid ."&oddid=". $row['credit_hist_odd_id']."' >". $bet_counter ."</a></strong></div></td>";
					}
