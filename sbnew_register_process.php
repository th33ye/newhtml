...
function sendRegstrationEmail($sname, $pwd, $rndNo, $emailto)
{
	...
	$body =  "Welcome Kabayang Sabongero, \n\n". 
			 ...
			 "This is an autogenerated mail. Pls do not reply to this mail.\n".
			 "Please send your inquiries or technical concerns to mailto:csupport@sabongnow.com.\n\n". 
...
if(!empty($_POST['user_username']) && !empty($_POST['password']) && !empty($_POST['user_email']) )
{
	...
	if (isValidEmail($user_email) == false)
	{
		...
		header("location:sbnew_register.php"); // image validator is not correct!
	}
	else
	{
		include 'class.php';
...
//			include 'dbconn_normal.php'; // using mysql_connect
			...
			{ 
				...
				if( $row = mysqli_fetch_array($result, MYSQLI_ASSOC) )
				{
					...
					mysqli_close($link);
					header("location:sbnew_register.php"); 
				}
			...
			{
				$rand = rand_str();
				$insSQL = "INSERT INTO users (user_email, user_username, user_password, user_country, user_activation_code, user_affiliate_code) 
							VALUES ('" . mysqli_real_escape_string($link,$user_email) 
								. "','" . mysqli_real_escape_string($link,$username) 
								. "',md5('" . mysqli_real_escape_string($link,$password)
								. "'),'" . $myCountry
								. "','" . $rand
								. "','" . $affiliateCode
								. "');";
				
				if ($result3 = mysqli_query($link,$insSQL)) 
				{
					...
					if ($retID <> 0) // check if there's a returned user id
					{
						...
						header("location:sbnew_register_success.php");
					}
					else
					{
