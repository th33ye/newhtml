                  ...
                  if (data.success == '1') {
                     ...
                     for (var i=0;i<=count;i++) {
                        ...
                        var link = '<a href=\'javascript:loggedOutUser('+data.users_online[i].user_id+');\'>Log-out</a>&nbsp;&nbsp;'
								 ...
								 + '<a href=\'javascript:allowChat('+data.users_online[i].user_id+');\'>Chat</a>&nbsp;&nbsp;'
								 + '<a href=\'javascript:noChat('+data.users_online[i].user_id+');\'>No Chat</a>';
