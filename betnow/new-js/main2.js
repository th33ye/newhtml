var ChatAnywhere	= function(){
	var channelName	= jQuery.url.param("channel")	|| "sabongnow-chat";
	...
	var updateChatArea	= function(tmplClass, tmplData){
		...
		//chatAreaEl.scrollTop = jQuery("#container .chatArea").offset().top + 1000;
		//var height = jQuery("#container .chatArea")[0].scrollHeight;
		//charAreaEl.scrollTop = height;

		var chatAreaEl = jQuery("#container .chatArea");
		chatAreaEl.scrollTop(chatAreaEl.get(0).scrollHeight);
	}
    ...
    //var socketUrl = "ws://27.126.152.138/"+channelName;
    var socketUrl = "ws://109.203.104.215/"+channelName;
    //var socketUrl = "ws://www.sabongnow.com/"+channelName;
