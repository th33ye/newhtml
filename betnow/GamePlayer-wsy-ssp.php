...
<head>
    ...
    <script type="text/javascript">
        ...
        //            alert('You have been logged out.');
           ...
           setTimeout("trackLogin('<?php echo $_SESSION['user_user_id']; ?>')", 10000);
        }
        ...
        //         }
           ...
           setTimeout("popCredit('<?php echo $_SESSION['user_user_id']; ?>')", 15000);
        }
        ...
        function popBlock(userid)
        {
           ...
           setTimeout("popBlock('<?php echo $_SESSION['user_user_id']; ?>')", 15000);
        }
        ...
        function refreshFightResults()
        {
            ...
            setTimeout('refreshFightResults()', 10000);
        }
    ...
    <div id="game_container">
        <div id="game_header_container">
            <div id="game_header_arena">
                <span><?php echo $_SESSION['arena'] . ' (3.5% Plasada!)'; ?></span>
            </div>
