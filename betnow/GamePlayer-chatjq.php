...
<script type="text/javascript" src="js/gamestat.js"></script>
...
function submit_chat() {
	var text = $("#sendie").val();
	var name = <?php echo $_SESSION['user_username']; ?>
	chat.send(text, name);
	#("#sendie").val("");
}
            ...
            <tr>
				<td>
					<div id="chat-container">
						<div id="chat-title">
							<h2>www.sabongnow.com - chatter box (beta)</h2>
						</div>
						<div id="chat-wrap"><div id="chat-area"></div></div>
						<div id="game-result">
							<div id="gr-left">
								<span>GAME</span>
								<input class="result gno" type="text" name="gamenumber" id="gamenumber" disabled="disabled" />
							</div>
							<div id="gr-center">
								<span>STATUS</span>
								<input class="result gstat" type="text" name="gamestatus" id="gamestatus" disabled="disabled" />
							</div>
							<div id="gr-right">
						        <span>RESULT</span>
				                <input class="result gresult" type="text" name="gameresult" id="gameresult" disabled="disabled" />
				            </div>
						</div>
						<div id="msg-area">
							<form id="send-message-area" action="#">
								<textarea id="sendie" maxlength='150'></textarea>
								<input type="submit" id="btn-send" value="Send" onclick="submit_chat()" />
							</form>
						</div>
					</div>
                </td>
				...
				<td>
					<table width="100%" border="0" cellpadding="0" cellspacing="3">
						<tr>
							...
							<td width="33%"><input type="radio" name="radio" id="rbWala" value="betType" />Wala</td>
							<td width="85"><div id="BetStatus">
								<input name="radio" type="radio" id="rbMeron" value="betType" checked="checked" />Meron</div>
							</td>
						</tr>	
						<tr>
							<td >Odds </td>
